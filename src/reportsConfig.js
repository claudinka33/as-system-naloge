...
export const REPORT_TEMPLATES = {
  proizvodnja: {
    ...
    fields: [
      ...
      { key: 'completed_vijaki', label: 'Izvedeni Vijaki', type: 'number', placeholder: '0', unit: 'KOS', group: 'completed' },
      { key: 'completed_pini', label: 'Izvedeni PINI', type: 'number', placeholder: '0', unit: 'KOS', group: 'completed' },
      { key: 'completed_sidra', label: 'Izvedeni Sidra', type: 'number', placeholder: '0', unit: 'KOS', group: 'completed' },
      { key: 'completed_struzena', label: 'Izvedena Stružena sidra', type: 'number', placeholder: '0', unit: 'KOS', group: 'completed' },
      { key: 'completed_ostalo', label: 'Izvedeno Ostalo', type: 'number', placeholder: '0', unit: 'KOS', group: 'completed' },
      { key: 'open_group', label: 'Število odprtih nalogov (KOS)', type: 'group_header' },
      { key: 'open_vijaki', label: 'Odprti Vijaki', type: 'number', placeholder: '0', unit: 'KOS', group: 'open' },
      { key: 'open_pini', label: 'Odprti PINI', type: 'number', placeholder: '0', unit: 'KOS', group: 'open' },
      { key: 'open_sidra', label: 'Odprti Sidra', type: 'number', placeholder: '0', unit: 'KOS', group: 'open' },
      { key: 'open_struzena', label: 'Odprta Stružena sidra', type: 'number', placeholder: '0', unit: 'KOS', group: 'open' },
      { key: 'open_ostalo', label: 'Odprto Ostalo', type: 'number', placeholder: '0', unit: 'KOS', group: 'open' },
      { key: 'productivity_group', label: 'Produktivnost (avto)', type: 'group_header' },
      { key: 'normativ_total', label: 'Skupni normativ (KOS po normativu)', type: 'number', placeholder: '0', unit: 'KOS', group: 'productivity' },
      { key: 'time_total', label: 'Skupni delovni čas', type: 'number', placeholder: '0', unit: 'ur', group: 'productivity' },
